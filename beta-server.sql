...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2023 at 05:57 AM
...
--
-- Table structure for table `beta-list`
--

CREATE TABLE `beta-list` (
  `id` int(11) NOT NULL,
  `fccode` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `beta-list`
--

INSERT INTO `beta-list` (`id`, `fccode`) VALUES
(0, 'A113-211'),
(0, 'A113-211'),
(0, 'T201-013'),
(0, 'T201-013'),
